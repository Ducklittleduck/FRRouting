...
/* match_ip_address_prefix_list => "match ip address prefix-list PREFIXLIST4_NAME$name" */
...
/* no_match_ip_address_prefix_list => "no match ip address prefix-list [PREFIXLIST4_NAME]" */
...
DEFUN_CMD_FUNC_TEXT(no_match_ip_address_prefix_list)
{
	...
	return no_match_ip_address_prefix_list_magic(self, vty, argc, argv, prefixlist4_name);
}
...
/* match_ip_next_hop_prefix_list => "match ip next-hop prefix-list PREFIXLIST4_NAME$name" */
...
/* no_match_ip_next_hop_prefix_list => "no match ip next-hop prefix-list [PREFIXLIST4_NAME]" */
...
DEFUN_CMD_FUNC_TEXT(no_match_ip_next_hop_prefix_list)
{
	...
	return no_match_ip_next_hop_prefix_list_magic(self, vty, argc, argv, prefixlist4_name);
}
...
/* match_ipv6_address_prefix_list => "match ipv6 address prefix-list PREFIXLIST6_NAME$name" */
...
/* no_match_ipv6_address_prefix_list => "no match ipv6 address prefix-list [PREFIXLIST6_NAME]" */
...
DEFUN_CMD_FUNC_TEXT(no_match_ipv6_address_prefix_list)
{
	...
	return no_match_ipv6_address_prefix_list_magic(self, vty, argc, argv, prefixlist6_name);
}
...
/* match_tag => "match tag <untagged$untagged|(1-4294967295)$tagged>" */
...
#define funcdecl_match_tag static int match_tag_magic(\
	...
	const char * untagged,\
	long tagged,\
	const char * tagged_str __attribute__ ((unused)))
funcdecl_match_tag;
DEFUN_CMD_FUNC_TEXT(match_tag)
{
	...
	unsigned _fail = 0, _failcnt = 0;
#endif
	const char *untagged = NULL;
	long tagged = 0;
	const char *tagged_str = NULL;
	...
	for (_i = 0; _i < argc; _i++) {
		...
		if (!strcmp(argv[_i]->varname, "untagged")) {
			untagged = (argv[_i]->type == WORD_TKN) ? argv[_i]->text : argv[_i]->arg;
		}
		if (!strcmp(argv[_i]->varname, "tagged")) {
			tagged_str = argv[_i]->arg;
			char *_end;
			tagged = strtol(argv[_i]->arg, &_end, 10);
			_fail = (_end == argv[_i]->arg) || (*_end != '\0');
		}
#if 1 /* anything that can fail? */
		if (_fail)
	...
	return match_tag_magic(self, vty, argc, argv, untagged, tagged, tagged_str);
}

/* no_match_tag => "no match tag [<untagged|(1-4294967295)>]" */
...
/* set_metric => "set metric <(-4294967295-4294967295)$metric|rtt$rtt|+rtt$artt|-rtt$srtt|igp$igp|aigp$aigp>" */
...
DEFUN_CMD_FUNC_TEXT(set_metric)
{
	...
	for (_i = 0; _i < argc; _i++) {
		...
		if (!strcmp(argv[_i]->varname, "aigp")) {
			aigp = (argv[_i]->type == WORD_TKN) ? argv[_i]->text : argv[_i]->arg;
		}
#if 1 /* anything that can fail? */
		if (_fail)
			vty_out (vty, "%% invalid input for %s: %s\n",
	...
	return set_metric_magic(self, vty, argc, argv, metric, metric_str, rtt, artt, srtt, igp, aigp);
}
...
/* set_min_metric => "set min-metric <(0-4294967295)$metric>" */
DEFUN_CMD_FUNC_DECL(set_min_metric)
#define funcdecl_set_min_metric static int set_min_metric_magic(\
	const struct cmd_element *self __attribute__ ((unused)),\
	struct vty *vty __attribute__ ((unused)),\
	int argc __attribute__ ((unused)),\
	struct cmd_token *argv[] __attribute__ ((unused)),\
	long metric,\
	const char * metric_str __attribute__ ((unused)))
funcdecl_set_min_metric;
DEFUN_CMD_FUNC_TEXT(set_min_metric)
{
#if 1 /* anything to parse? */
	int _i;
#if 1 /* anything that can fail? */
	...
	return set_min_metric_magic(self, vty, argc, argv, metric, metric_str);
}

/* no_set_min_metric => "no set min-metric [(0-4294967295)]" */
DEFUN_CMD_FUNC_DECL(no_set_min_metric)
#define funcdecl_no_set_min_metric static int no_set_min_metric_magic(\
	const struct cmd_element *self __attribute__ ((unused)),\
	struct vty *vty __attribute__ ((unused)),\
	int argc __attribute__ ((unused)),\
	struct cmd_token *argv[] __attribute__ ((unused)),\
	long min_metric,\
	const char * min_metric_str __attribute__ ((unused)))
funcdecl_no_set_min_metric;
DEFUN_CMD_FUNC_TEXT(no_set_min_metric)
{
#if 1 /* anything to parse? */
	int _i;
#if 1 /* anything that can fail? */
	...
	return no_set_min_metric_magic(self, vty, argc, argv, min_metric, min_metric_str);
}

/* set_max_metric => "set max-metric <(0-4294967295)$metric>" */
DEFUN_CMD_FUNC_DECL(set_max_metric)
#define funcdecl_set_max_metric static int set_max_metric_magic(\
	const struct cmd_element *self __attribute__ ((unused)),\
	struct vty *vty __attribute__ ((unused)),\
	int argc __attribute__ ((unused)),\
	struct cmd_token *argv[] __attribute__ ((unused)),\
	long metric,\
	const char * metric_str __attribute__ ((unused)))
funcdecl_set_max_metric;
DEFUN_CMD_FUNC_TEXT(set_max_metric)
{
#if 1 /* anything to parse? */
	int _i;
#if 1 /* anything that can fail? */
	...
	return set_max_metric_magic(self, vty, argc, argv, metric, metric_str);
}

/* no_set_max_metric => "no set max-metric [(0-4294967295)]" */
DEFUN_CMD_FUNC_DECL(no_set_max_metric)
#define funcdecl_no_set_max_metric static int no_set_max_metric_magic(\
	const struct cmd_element *self __attribute__ ((unused)),\
	struct vty *vty __attribute__ ((unused)),\
	int argc __attribute__ ((unused)),\
	struct cmd_token *argv[] __attribute__ ((unused)),\
	long max_metric,\
	const char * max_metric_str __attribute__ ((unused)))
funcdecl_no_set_max_metric;
DEFUN_CMD_FUNC_TEXT(no_set_max_metric)
{
#if 1 /* anything to parse? */
	int _i;
#if 1 /* anything that can fail? */
...
#endif
	long max_metric = 0;
	const char *max_metric_str = NULL;
	...
	for (_i = 0; _i < argc; _i++) {
		...
		if (!strcmp(argv[_i]->varname, "max_metric")) {
			max_metric_str = argv[_i]->arg;
			char *_end;
			max_metric = strtol(argv[_i]->arg, &_end, 10);
			_fail = (_end == argv[_i]->arg) || (*_end != '\0');
		}
#if 1 /* anything that can fail? */
		if (_fail)
	...
	return no_set_max_metric_magic(self, vty, argc, argv, max_metric, max_metric_str);
}

/* set_tag => "set tag <untagged$untagged|(1-4294967295)$tagged>" */
...
DEFUN_CMD_FUNC_TEXT(set_tag)
{
	...
	return set_tag_magic(self, vty, argc, argv, untagged, tagged, tagged_str);
}

/* no_set_tag => "no set tag [<untagged|(1-4294967295)>]" */
