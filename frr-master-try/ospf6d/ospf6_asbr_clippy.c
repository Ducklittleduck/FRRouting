/* ospf6_redistribute => "redistribute <kernel|connected|local|static|ripng|isis|bgp|table|vnc|babel|openfabric|table-direct>[{metric (0-16777214)|metric-type (1-2)$metric_type|route-map RMAP_NAME$rmap_str}]" */
