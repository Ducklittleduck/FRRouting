...
/* ripng_redistribute => "[no] redistribute <kernel|connected|local|static|ospf6|isis|bgp|table|vnc|babel|openfabric|table-direct>$protocol [{metric (0-16)|route-map RMAP_NAME$route_map}]" */
...
/* ripng_ipv6_distribute_list => "ipv6 distribute-list ACCESSLIST6_NAME$name <in|out>$dir [WORD$ifname]" */
DEFUN_CMD_FUNC_DECL(ripng_ipv6_distribute_list)
#define funcdecl_ripng_ipv6_distribute_list static int ripng_ipv6_distribute_list_magic(\
	const struct cmd_element *self __attribute__ ((unused)),\
	struct vty *vty __attribute__ ((unused)),\
	int argc __attribute__ ((unused)),\
	struct cmd_token *argv[] __attribute__ ((unused)),\
	...
	const char * dir,\
	const char * ifname)
funcdecl_ripng_ipv6_distribute_list;
DEFUN_CMD_FUNC_TEXT(ripng_ipv6_distribute_list)
{
#if 3 /* anything to parse? */
	int _i;
#if 0 /* anything that can fail? */
	...
	return ripng_ipv6_distribute_list_magic(self, vty, argc, argv, name, dir, ifname);
}

/* ripng_ipv6_distribute_list_prefix => "ipv6 distribute-list prefix PREFIXLIST6_NAME$name <in|out>$dir [WORD$ifname]" */
DEFUN_CMD_FUNC_DECL(ripng_ipv6_distribute_list_prefix)
#define funcdecl_ripng_ipv6_distribute_list_prefix static int ripng_ipv6_distribute_list_prefix_magic(\
	const struct cmd_element *self __attribute__ ((unused)),\
	struct vty *vty __attribute__ ((unused)),\
	int argc __attribute__ ((unused)),\
	struct cmd_token *argv[] __attribute__ ((unused)),\
	...
	const char * dir,\
	const char * ifname)
funcdecl_ripng_ipv6_distribute_list_prefix;
DEFUN_CMD_FUNC_TEXT(ripng_ipv6_distribute_list_prefix)
{
#if 3 /* anything to parse? */
	int _i;
#if 0 /* anything that can fail? */
	...
	return ripng_ipv6_distribute_list_prefix_magic(self, vty, argc, argv, name, dir, ifname);
}

/* no_ripng_ipv6_distribute_list => "no ipv6 distribute-list [ACCESSLIST6_NAME$name] <in|out>$dir [WORD$ifname]" */
DEFUN_CMD_FUNC_DECL(no_ripng_ipv6_distribute_list)
#define funcdecl_no_ripng_ipv6_distribute_list static int no_ripng_ipv6_distribute_list_magic(\
	const struct cmd_element *self __attribute__ ((unused)),\
	struct vty *vty __attribute__ ((unused)),\
	int argc __attribute__ ((unused)),\
	struct cmd_token *argv[] __attribute__ ((unused)),\
	...
	const char * dir,\
	const char * ifname)
funcdecl_no_ripng_ipv6_distribute_list;
DEFUN_CMD_FUNC_TEXT(no_ripng_ipv6_distribute_list)
{
#if 3 /* anything to parse? */
	int _i;
#if 0 /* anything that can fail? */
	...
	return no_ripng_ipv6_distribute_list_magic(self, vty, argc, argv, name, dir, ifname);
}

/* no_ripng_ipv6_distribute_list_prefix => "no ipv6 distribute-list prefix [PREFIXLIST6_NAME$name] <in|out>$dir [WORD$ifname]" */
DEFUN_CMD_FUNC_DECL(no_ripng_ipv6_distribute_list_prefix)
#define funcdecl_no_ripng_ipv6_distribute_list_prefix static int no_ripng_ipv6_distribute_list_prefix_magic(\
	const struct cmd_element *self __attribute__ ((unused)),\
	struct vty *vty __attribute__ ((unused)),\
	int argc __attribute__ ((unused)),\
	struct cmd_token *argv[] __attribute__ ((unused)),\
	...
	const char * dir,\
	const char * ifname)
funcdecl_no_ripng_ipv6_distribute_list_prefix;
DEFUN_CMD_FUNC_TEXT(no_ripng_ipv6_distribute_list_prefix)
{
#if 3 /* anything to parse? */
	int _i;
#if 0 /* anything that can fail? */
	...
	return no_ripng_ipv6_distribute_list_prefix_magic(self, vty, argc, argv, name, dir, ifname);
}
